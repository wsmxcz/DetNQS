...
from . import _detnqs_cpp  # nanobind bridge to C++ integral backend
...
class MolecularSystem:
    ...
    _int_ctx: Optional[_detnqs_cpp.IntCtx] = field(
    ...
    def from_fcidump(
        ...
        int_ctx = _detnqs_cpp.IntCtx(str(path), int(n_orb))
        if build_heat_bath:
