...
Example:
    ...
    >>>
    >>> # Select top 200 determinants by probability mass
    ...
    >>> new_s_dets = strategy.evolve(ctx, psi_cache)
...
from .selectors import CumulativeMassSelector
